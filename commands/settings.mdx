...
```bash
puzldai observe summary           # Show stats
puzldai observe list              # List recent
puzldai observe export data.jsonl # Export to file
```
...
puzldai serve --mcp               # MCP bridge mode
...
```bash
puzldai login                     # Login to cloud
puzldai logout                    # Logout
puzldai whoami                    # Show login status
```
