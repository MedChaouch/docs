...
```bash
/debate <agents> --rounds <n> "<topic>"
```

### Examples

```bash
# Two-round debate between Claude and Gemini
/debate claude,gemini --rounds 2 "GraphQL vs REST for our API"

# Three-model debate
/debate claude,gemini,codex --rounds 2 "Monolith vs microservices"
```
