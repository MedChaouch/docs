...
<CardGroup cols={2}>
  ...
  <Card title="Autopilot" icon="robot" href="/modes/autopilot">
    AI generates an execution plan and runs it autonomously or interactively.
  </Card>
...
| **Autopilot** | Complex tasks requiring multi-step execution plans |
